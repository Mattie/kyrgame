...
- [x] Added an admin-only mob tracker endpoint and navigator panel exposing current legacy animation state (`dloc`, brownie `bloc`/`bpidx`, elf last sighting, and Zar object presence) for live parity debugging.
