...
- [x] Preserved `msgutl2`-style actor-visible room-script effects across all active WebSocket sessions for the player, covering multi-session fan-out for self-target YAML events.
