...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("nmpdes", sa.Integer(), nullable=False),
        sa.Column("modno", sa.Integer(), nullable=False),
        sa.Column("level", sa.Integer(), nullable=False),
        ...
        sa.Column("gemidx", sa.Integer(), nullable=False),
        sa.Column("stones", sa.JSON(), nullable=False),
        sa.Column("macros", sa.Integer(), nullable=False),
        sa.Column("stumpi", sa.Integer(), nullable=False),
        sa.Column("spouse", sa.String(length=14), nullable=False),
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint("gemidx >= 0 AND gemidx <= 4", name="ck_players_gemidx_range"),
        sa.CheckConstraint("stumpi >= 0 AND stumpi <= 12", name="ck_players_stumpi_range"),
        sa.CheckConstraint("macros >= 0 AND macros <= 19", name="ck_players_macros_range"),
    )
